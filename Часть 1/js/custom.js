...
//Задание 3.3 Подключить и настроить google-карту. Кастомизировать метку, настроить попап с подсказкой. - есть

//Задание 3.5 Реализовать набегающий счетчик вот этих цифр.
$('.js-post-info__counter').counterUp({
    delay: 30,
    time: 2000
});
//Задание 3.6 Выполнить анимацию вот этих блоков при появлении в окне экрана
new WOW().init();

//Задание 3.9 Выполнить анимацию вот этих блоков при появлении в окне экрана
var options = {
    strings: ["Strength in equality", "The power of dreams"],
    typeSpeed: 40
};
var typed = new Typed(".js-title-typed", options);

//Задание 3.10 •	Стилизовать чекбоксы (в модальном окне чекбокс есть)
$('input').iCheck({
    checkboxClass: 'icheckbox_polaris',
    radioClass: 'iradio_polaris',
    increaseArea: '-10%'
});
//Задание 3.12 Валидация форм
$(function() {
    $('#js-login-from').validate({
        rules: {
            form__name: {
                required:true
            },
